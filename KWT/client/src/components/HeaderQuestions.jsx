    ...
    const elements = [
        {
            ...
            paragraph: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque cupiditate delectus unde magni culpa itaque quod doloribus cum non eum rem alias odio praesentium voluptatum sequi natus, magnam quasi necessitatibus labore quisquam. Excepturi aliquam distinctio, fuga odio odit soluta temporibus.",
            bg: '#070707',
            color: '#fff',
            headColor: "#fff",
        },
                ...
                {elements.map((element, i) => {
                        return (
                            <div className="Qelements" style={{
                                ...
                                {(((window.innerWidth<=1120) && (i % 2 == 0))||((window.innerWidth<=1120) && (i % 2 != 0))) && <div className="Qimage" id="img "style={{
                                    background:`url(${element.img})`,
                                }}>
                                        <div className="Qimg"></div>
                                </div>}
